...
const TableCreator = () => {
  ...
  const users = [
    {
      ...
      userEmail: "dheeraj123@gmail.com",
    ...
    },
    {
      ...
      userEmail: "sushil456@gmail.com",
      userPhone: "9876543211",
      registrationDate: "12th Feb 2023",
    },
    {
      userId: "67890",
      userName: "Ajay Kumar",
  ...
  const handleViewClick = (
    ...
    router.push(
      `/profileUser?userId=${encodeURIComponent(userId)}&name=${encodeURIComponent(userName)}&email=${encodeURIComponent(userEmail)}&phone=${encodeURIComponent(userPhone)}&registrationDate=${encodeURIComponent(registrationDate)}`,
    );
  };
    ...
    <div className="rounded-[10px] bg-white px-7.5 pb-4 pt-7.5 shadow-1 dark:bg-gray-dark dark:shadow-card">
      ...
      <div className="flex flex-col">
        ...
        {users.map((user) => (
          <div
            key={user.userId}
            className="grid grid-cols-3 items-center border-b border-gray-200 py-4 dark:border-gray-700 sm:grid-cols-6"
          >
            <div className="flex items-center px-2">
              <span>{user.userId}</span>
            </div>
            <div className="px-2 text-center">{user.userName}</div>
            <div className="px-2 text-center">{user.userEmail}</div>
