      ...
      <table className="w-full border-collapse">
        ...
        <tbody>
          {brands.map((brand, key) => (
            <tr key={brand._id} className={key === brands.length - 1 ? "" : "border-b border-stroke dark:border-dark-3"}>
