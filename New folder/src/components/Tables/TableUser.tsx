      ...
      <div className="flex flex-col">
        <div className="grid grid-cols-3 sm:grid-cols-6">
          <div className="px-2 pb-3.5">
            <h5 className="text-sm font-medium uppercase xsm:text-base">User Id</h5>
          </div>
          <div className="px-2 pb-3.5 text-center">
            <h5 className="text-sm font-medium uppercase xsm:text-base">Name</h5>
          </div>
          <div className="px-2 pb-3.5 text-center">
            <h5 className="text-sm font-medium uppercase xsm:text-base">Email Id</h5>
          </div>
        ...
        <div className="grid grid-cols-3 sm:grid-cols-6 items-center py-4 border-b border-gray-200 dark:border-gray-700">
          <div className="flex items-center px-2">
            <span>12345</span>
          </div>
          <div className="px-2 text-center">Dheeraj Yadav</div>
          <div className="px-2 text-center">dheeraj123@gmail.com</div>
          <div className="hidden px-2 text-center sm:block">9876543210</div>
          <div className="hidden px-2 text-center sm:block">10th Jan 2024</div>
