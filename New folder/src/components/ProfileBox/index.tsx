    ...
    <div className="overflow-hidden rounded-[10px] bg-white shadow-1 dark:bg-gray-dark dark:shadow-card">
      ...
      <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
        ...
        <div className="mt-4">
          ...
          <p className="font-medium">Content Creator</p>            <div className="mx-auto mt-4.5 mb-5.5 grid max-w-94 grid-cols-3 rounded-md border border-stroke py-2.5 shadow-1 dark:border-dark-3 dark:bg-dark-2">
      ...
      <div className="flex justify-center border-b border-gray-300 dark:border-gray-700">
        <button
          className={`py-2 px-4 text-lg ${activeTab === "posts" ? "border-b-2 border-primary text-primary" : "text-gray-600"}`}
          onClick={() => setActiveTab("posts")}
        >
          Posts
        </button>
        <button
          className={`py-2 px-4 text-lg ${activeTab === "affiliate" ? "border-b-2 border-primary text-primary" : "text-gray-600"}`}
      ...
      <div className="py-4">
        {activeTab === "posts" && (
          <div>
            <h4 className="text-xl font-semibold text-dark dark:text-white">Posts</h4>
            <p className="mt-2 text-sm text-gray-500 dark:text-gray-300">
              Here will be the creator's posts content.
            </p>
            ...
            <div className="grid grid-cols-3 gap-4 mt-4">
              {posts.map((post) => (
                <div key={post.id} className="bg-gray-100 p-4 rounded-lg">
                  ...
                  <p className="mt-2 text-center text-gray-700 dark:text-gray-300">{post.caption}</p>
                </div>
              ))}
            </div>
          </div>
        ...
        {activeTab === "affiliate" && (
          <div>
            <h4 className="text-xl font-semibold text-dark dark:text-white">Affiliate Details</h4>
            <p className="mt-2 text-sm text-gray-500 dark:text-gray-300">
              Here will be the creator's affiliate details like revenues, sales, and visitors.
            </p>
            {/* Display creator's affiliate details here */}
            <div className="mt-4">
              <p><strong>Revenues:</strong> {creator?.revenues}</p>
              <p><strong>Sales:</strong> {creator?.sales}</p>
              <p><strong>Visitors:</strong> {creator?.visitors}</p>
              <p><strong>Conversion Rate:</strong> {creator?.conversion}%</p>
            </div>
          </div>
        )}
      </div>
